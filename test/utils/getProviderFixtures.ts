...
const getProviderFixtures = (provider: TRANSACTION_PROVIDER) => {
  const fixtures = {
    ...
    [TRANSACTION_PROVIDER.STRIPE]: {
      safeUnusedId: process.env.TESTING_STRIPE_FIXTURE_SAFE_UNUSED_ID!,

      transactionProviderId:
        process.env.TESTING_STRIPE_FIXTURE_TRANSACTION_PROVIDER_ID!,
      transactionId: process.env.TESTING_STRIPE_FIXTURE_TRANSACTION_ID!,

      customerPaymentMethodId:
        process.env.TESTING_STRIPE_FIXTURE_CUSTOMER_PAYMENT_METHOD_ID!,

      paymentPlanId: process.env.TESTING_STRIPE_FIXTURE_PAYMENT_PLAN_ID!,
      paymentPlanTemplateId:
        process.env.TESTING_STRIPE_FIXTURE_PAYMENT_PLAN_TEMPLATE_ID!,

      merchantInternalCustomerCode:
        process.env.TESTING_STRIPE_FIXTURE_MERCHANT_INTERNAL_CUSTOMER_CODE!,
      merchantInternalTransactionCode:
        process.env.TESTING_STRIPE_FIXTURE_MERCHANT_INTERNAL_TRANSACTION_CODE!,

      providerTransactionCode:
        process.env.TESTING_STRIPE_FIXTURE_PROVIDER_TRANSACTION_CODE!,
      providerCustomerPaymentMethodCode:
        process.env
          .TESTING_STRIPE_FIXTURE_PROVIDER_CUSTOMER_PAYMENT_METHOD_CODE!,

      providerPaymentPlanCode:
        process.env.TESTING_STRIPE_FIXTURE_PROVIDER_PAYMENT_PLAN_CODE!,
      providerPaymentPlanTemplateCode:
